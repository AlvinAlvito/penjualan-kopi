...
<table class="table table-bordered">
    <thead><tr><th>Rank</th><th>Produk</th><th>Sim Query</th><th>Sim Profile</th><th>Final</th></tr></thead>
    <tbody>
    ...
    @empty
        <tr><td colspan="5" class="text-center">Masukkan query untuk melihat hasil.</td></tr>
    @endforelse
    </tbody>
</table>
@endsection
